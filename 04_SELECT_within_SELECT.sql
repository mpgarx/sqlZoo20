--################################
--#
--#  04 SELECT within SELECT Tutorial
--#
--################################
...
--    "select the country details from world where the area is greater than or equal 
--     to the area of all countries where the continent is the same"
