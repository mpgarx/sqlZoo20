...
-- . Scientific Notation:
--     Some implementations of SQL may show large numbers in scientific notation. 
--     The number 6.23 E9 means 6.23 x 10 9 which is 6.23 x 1,000,000,000 which is 6,230,000,000
...
-- For South America show population in millions (6 zeros) and GDP in billions (9 zeros) both to 2 decimal places
